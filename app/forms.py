...
CHECKPOINTS = [
    ...
    ('SD15/Swizz8-REAL-BakedVAE-FP16.safetensors', 'Swizz8 REAL BakedVAE FP16', False),
    ('SD15/absolutereality_v181.safetensors', 'Absolute Reality v1.8.1', True),
    ...
    ('SD15/eosamFilmgirUltra_ultraBaseModel.safetensors', 'EOSAM Filmgir Ultra Base Model', False),
    ('SD15/mchsMachinecodesComi_v2.safetensors', 'MCHS Machinecodes Comic v2', False),
    ('SD15/revAnimated_v121.safetensors', 'Rev Animated v1.2.1', False),
    ('SD15/timAmericanCartoons_genesis.safetensors', 'Tim American Cartoons Genesis', False),
    ('SD15/urpm.safetensors', 'URPM', False),
    ('SDXL/AnythingXL_xl.safetensors', 'Anything XL', True),
    ('SDXL/JuggernautXL_X_RunDiffusionXL.safetensors', 'Juggernaut XL X RunDiffusion XL', False),
    ('SDXL/JuggernautXLSDXL_V7Bakedvae.safetensors', 'Juggernaut XL SDXL V7 Baked VAE', False),
    ...
    ('SDXL/dynavisionXLAllInOneStylized_release0557Bakedvae.safetensors',
     'Dynavision XL All In One Stylized 0557 Baked VAE', False),
    ...
    ('SDXL/leosamshelloworldXL_leosamhelloworldXL70.safetensors', 'Leosam Hello World XL 70', False),
